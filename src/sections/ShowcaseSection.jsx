                ...
                <div className='showcaselayout'>
                    ...
                    <div className='project-list-wrapper overflow-hidden'>
                        ...
                        <div className='project' ref={project3Ref}>
                            {/* <div className='image-wrapper bg-[#ffe7eb]'> */}
                            <div className='flex items-center justify-items-center pt-6 hover:scale-110 transition-all duration-500 ease-in-out'>
                                <a href='https://smart-interview-ai-client.vercel.app' target='_blank'>
                                    <img src='/images/project5.png' alt='Ai-Smart-interview' />
                                </a>
                            </div>
                            {/* </div> */}
                            <h2>An advance Ai powered,smart personalized interviewer.</h2>
                        </div>
                    </div>
                    ...
                    <div className='project-list-wrapper overflow-hidden'>
                        ...
                        <div className='project' ref={project3Ref}>
                            ...
                            <div className='flex items-center justify-items-center pt-6 hover:scale-110 transition-all duration-500 ease-in-out'>
                                <a href='https://virtual-assistant-lilac.vercel.app/' target='_blank'>
                                    <img src='/images/project3.png' alt='virtual assistant' />
                                </a>
                            </div>
                            {/* </div> */}
                        ...
                        <div className='project' ref={project3Ref}>
                            ...
                            {/* </div> */}
                            <h2>A realtime, responsive user friendly chat web application.</h2>
                        </div>
                    </div>
                </div>
            </div>
